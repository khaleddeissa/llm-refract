...
| [Search](usage/search.md)         | Filter scoped executions, paginate and find lexically similar failures        |
...
| [OpenTelemetry](usage/otel.md)    | Import/export OTLP JSON and bridge SDK traces                                 |
